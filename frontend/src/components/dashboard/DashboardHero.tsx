...
export function DashboardHero() {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-default-200/80 bg-gradient-to-br from-default-50 via-background to-primary-50/30 p-6 shadow-sm md:p-8">
